    ...
    <section className="bg-[#00091A] pb-20 text-white ">
      <div className="w-[86%] mx-auto max-w-7xl ">
        ...
        <div className=" flex gap-20  justify-center items-center  mx-auto mt-10  ">
          ...
          <p className="">
We take immense pride in our status as a Salesforce CREST Partner and Microsoft Solutions Partner. Our expertise in CRM and cloud solutions has led us to recognition as a Clutch Global Leader 2025, a spot among Clutch's Top 100 Fastest-Growing Companies, and the Times Power Brand 2024 Award for Excellence in AI. These accolades inspire us to continue empowering businesses with world-class digital transformation services.           </p>
        </div>
        </div>
