  ...
  return (
    <section className="bg-[#00091A] pb-20 text-white ">
      <div className="w-[86%] mx-auto max-w-7xl ">
        <SectionHeader title="Recognized Excellence in Technology Solutions " />
        <div className=" flex gap-20  justify-center items-center  mx-auto mt-10  ">
          ...
          <div className=" space-y-6 w-[40%] text-white text-opacity-70 text-sm ">
            <p className="">
              We are proud to be a Salesforce CREST Partner and a Microsoft Solutions Partner, empowering businesses with seamless digital transformation through world-class CRM and cloud solutions.      </p>
            <p>Our expertise has earned us recognition as a Clutch Global Leader 2025, along with being named among the Top 100 Fastest-Growing Companies by Clutch. Our innovation in Artificial Intelligence has also been honored with the Times Power Brand 2024 Award for Excellence in AI.</p>
